...
<html lang ="fr">
   ...
   <body>
      ...
      <form method="post" action="date1.php">
         <p>
         <div class = "label">
            <label for="date1"> Choisissez une date entre le: <br/></label><br/>
         </div>
         <input type="date" id="date1" name="date1" required
            minlength="1" maxlength="20" size="10">
         <div id = "label">
            <label for="date2"><br/> et le: <br/></label><br/>
         </div>
         <input type="date" id="date2" name="date2" required
            minlength="1" maxlength="20" size="10">
         <input type="submit" name="nom" value="Valider" />
         <input type="text" name="formulaire" class="none" value="filmpardate">
         </p>
